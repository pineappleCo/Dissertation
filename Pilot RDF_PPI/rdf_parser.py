...
import os, sys, rdflib, itertools, fileinput, argparse
...
def parse_options():
	...
	parser.add_argument('--biogrid', metavar='DATAFILE')
	parser.add_argument('--intact', metavar='DATAFILE', help='uniprot2entrez.txt must exist in path')
	parser.add_argument('--genenames', metavar='Entrez2Gene.txt')
	parser.add_argument('--homologene', metavar='homologene.data')
	parser.add_argument('--psd', metavar='psd_genes.txt', help='adds psd triples to post-synaptic density entrez ids')
	parser.add_argument('--filter', metavar='genes.txt', help="filters data to entrez ids in newline delimited file")
